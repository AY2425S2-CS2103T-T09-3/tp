...
public class EditCommand extends Command {
    ...
    public static final String MESSAGE_DUPLICATE_RESRVATION = "This reservation already exists in the address book.";
     ...
     */
    public EditCommand(Index index, EditReservationDescriptor editPersonDescriptor) {
        requireNonNull(index);
        requireNonNull(editPersonDescriptor);

        this.index = index;
        this.editReservationDescriptor = new EditReservationDescriptor(editPersonDescriptor);
    }
    ...
    public CommandResult execute(Model model) throws CommandException {
        ...
        if (!reservationToEdit.isSameReservation(editedReservation) && model.hasReservation(editedReservation)) {
            throw new CommandException(MESSAGE_DUPLICATE_RESRVATION);
        }
